...
from museum.models import OldSubmission
from submission.util import SubmissionStatus
from commons.utils import upload_linker, judge_linker
...
class Dispatcher:
    ...
    def __init__(self, submission_id):
        # The problems and submission are not bound to be the latest one, therefore
    ...
    def is_latest_data_for_server(self):
        server_status, _ = ServerProblemStatus.objects.get_or_create(
            ...
            defaults={'problems': Problem.objects.get(pk=self.problem_id),
