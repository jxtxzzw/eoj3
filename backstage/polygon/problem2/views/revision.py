...
from problems.dispatcher.models import ServerProblemStatus
...
from problems.models import SpecialProgram, get_input_path, get_output_path
from problems.tasks import upload_problem_to_judge_server


class RevisionCreateView(PolygonProblemMixin, View):
    """
    Directly create a revision from an online problems
    """
    @staticmethod
