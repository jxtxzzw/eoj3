...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('problems', '0022_taginfo_parent_id'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('problems', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='polygon_problems_favorite_by', to='problems.Problem')),
