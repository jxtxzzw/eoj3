...
class Migration(migrations.Migration):
  ...
  operations = [
    ...
    migrations.AlterField(
      model_name='program',
      name='lang',
      field=models.CharField(choices=[('cpp', 'C++11'), ('cc14', 'C++14'), ('java', 'Java'), ('python', 'Python')],
                             default='cc14', max_length=12, verbose_name='语言'),
    ),
    migrations.AlterField(
      model_name='program',
      name='name',
    ...
    migrations.AlterField(
      ...
      field=models.CharField(
        choices=[('checker', '输出校验'), ('interactor', '交互程序'), ('generator', '生成器'), ('validator', '输入校验'),
                 ('solution_main', '解答 - 标准答案'), ('solution_correct', '解答 - 正确'), ('solution_tle_or_ok', '解答 - 超时或正确'),
                 ('solution_wa', '解答 - 输出答案错误'), ('solution_incorrect', '解答 - 不正确'), ('solution_fail', '解答 - 运行时错误'),
                 ('useless', '没用的')], default='checker', max_length=24, verbose_name='标记为'),
    ),
    migrations.AlterField(
      model_name='revision',
      name='enable_group',
    ...
    migrations.AlterField(
      model_name='revision',
      name='status',
      field=models.IntegerField(choices=[(-1, 'Discarded'), (0, 'Undergoing'), (1, 'Done')], default=0,
                                verbose_name='状态'),
    ),
    migrations.AlterField(
      model_name='revision',
    ...
    migrations.AlterField(
      model_name='statement',
      name='name',
      field=models.CharField(default='default', max_length=24, validators=[polygon.models.NameValidator()],
                             verbose_name='助记符'),
    ),
    migrations.AlterField(
      model_name='statement',
    ...
    migrations.AlterField(
      ...
      field=models.CharField(
        ...
        default='cpp', max_length=12, verbose_name='语言'),
    ),
    migrations.AlterField(
      model_name='template',
      name='template_code',
