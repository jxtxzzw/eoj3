  ...
  operations = [
    migrations.CreateModel(
      ...
      fields=[
        ...
        ('file', models.FileField(
          storage=django.core.files.storage.FileSystemStorage(location='/Users/Scott/PycharmProject/eoj3-jan/repo'),
    ...
    migrations.CreateModel(
      ...
      fields=[
        ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
        ('name', models.CharField(max_length=24, validators=[polygon.models.NameValidator()])),
        ('lang', models.CharField(choices=[('cpp', 'C++'), ('java', 'Java'), ('python', 'Python')], default='cpp',
                                  max_length=12)),
        ('code', models.TextField(blank=True)),
        ('tag', models.CharField(
          choices=[('checker', 'checker'), ('interactor', 'interactor'), ('generator', 'generator'),
                   ('validator', 'validator'), ('solution_main', 'solution - main correct'),
                   ('solution_correct', 'solution - correct'),
                   ('solution_tle_or_ok', 'solution - time limit exceeded or correct'),
                   ('solution_wa', 'solution - wrong answer'), ('solution_incorrect', 'solution - incorrect'),
                   ('solution_fail', 'solution - runtime error'), ('useless', 'ignore me')], default='checker',
          max_length=24)),
        ('create_time', models.DateTimeField()),
        ('update_time', models.DateTimeField(auto_now=True)),
    ...
    migrations.CreateModel(
      ...
      fields=[
        ...
        ('parent_id', models.IntegerField(default=0)),
        ('active_checker',
         models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='checking_revisions',
                           to='polygon.Program')),
        ('active_interactor', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL,
                                                related_name='interacting_revisions', to='polygon.Program')),
      ],
    ),
    migrations.CreateModel(
      name='Statement',
    ...
    migrations.AddField(
      ...
      field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='stating_revisions',
                              to='polygon.Statement'),
    ),
    migrations.AddField(
      model_name='revision',
      name='active_validator',
      field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL,
                              related_name='validating_revisions', to='polygon.Program'),
    ),
    migrations.AddField(
      model_name='revision',
      name='assets',
    ...
    migrations.AddField(
      model_name='revision',
      name='problem',
      field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='revisions',
                              to='problem.Problem'),
    ),
    migrations.AddField(
      model_name='revision',
