...
class Migration(migrations.Migration):
  ...
  operations = [
    ...
    migrations.AlterField(
      model_name='activityparticipant',
      name='gender',
      field=models.CharField(blank=True, choices=[('m', '男'), ('f', '女'), ('d', '拒绝回答')], max_length=5,
                             verbose_name='性别'),
    ),
    migrations.AlterField(
      model_name='activityparticipant',
    ...
    migrations.AlterField(
      model_name='activityparticipant',
      name='major',
      field=models.CharField(blank=True, choices=[('art', '艺术'), ('accounting', '会计'), ('business', '商业'),
                                                  ('business_admin', '工商管理'), ('chemistry', '化学'),
                                                  ('communication', '通信'), ('ce', '计算机工程'), ('cs', '计算机科学'),
                                                  ('economics', '经济'), ('education', '教育'), ('ee', '电子工程'),
                                                  ('finance', '金融'), ('geology', '地理'), ('interaction', '人机交互'),
                                                  ('it', '信息技术'), ('life', '生命科学'), ('mechanics', '机械'),
                                                  ('linguistics', '语言学'), ('literature', '文学'), ('math', '数学'),
                                                  ('se', '软件工程'), ('philosophy', '哲学'), ('physics', '物理'),
                                                  ('politics', '政治学'), ('psycho', '心理学'), ('social', '社会学'),
                                                  ('translation', '翻译'), ('others', '其他')], max_length=30,
                             verbose_name='专业'),
    ),
    migrations.AlterField(
      model_name='activityparticipant',
    ...
    migrations.AlterField(
      ...
      field=models.PositiveIntegerField(
        choices=[(0, '仅比赛管理员可见'), (10, '仅受邀用户可见，赛后题目不公开'), (15, '仅受邀用户可见，赛后允许虚拟参赛'), (20, '仅受邀用户可见，赛后题目直接公开'),
                 (30, '公开，需要比赛前注册'), (40, '公开')], default=0, verbose_name='访问控制'),
    ),
    migrations.AlterField(
      model_name='contest',
      name='allow_code_share',
      field=models.IntegerField(
        choices=[(0, '不允许'), (1, '代码在赛后对 AC 用户公开（默认）'), (2, '代码在赛后完全公开'), (3, '代码在比赛过程中对 AC 用户公开')], default=1,
        verbose_name='允许代码共享'),
    ),
    migrations.AlterField(
      model_name='contest',
      ...
      field=models.CharField(
        default='c,cc14,cc17,cpp,cs,hs,java,js,ocaml,pas,perl,php,py2,pypy,pypy3,python,rs,scala,scipy,text',
        max_length=192, verbose_name='允许语言'),
    ),
    migrations.AlterField(
      model_name='contest',
    ...
    migrations.AlterField(
      ...
      field=models.IntegerField(choices=[(-10, '不可见'), (0, '默认'), (10, '总是可见')], default=0,
                                verbose_name='所有提交和榜单的访问控制'),
    ),
    migrations.AlterField(
      model_name='contest',
      name='contest_type',
    ...
    migrations.AlterField(
      ...
      field=models.CharField(
        choices=[('all', '所有测试点'), ('pretest', '只测试 Pretests'), ('sample', '只测试样例'), ('none', '不作测试')], default='all',
        max_length=10, verbose_name='比赛过程中对代码进行评测'),
    ),
    migrations.AlterField(
      model_name='contest',
      name='scoring_method',
      field=models.CharField(
        choices=[('acm', 'ACM 赛制'), ('oi', 'OI 赛制'), ('cf', 'School of Data Analysis (SDA) 赛制 (Codeforces...)'),
                 ('tcmtime', 'TCM/TIME 赛制 (GCJ...)')], default='acm', max_length=10, verbose_name='计分规则'),
    ),
    migrations.AlterField(
      model_name='contest',
