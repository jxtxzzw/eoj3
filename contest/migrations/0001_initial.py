  ...
  operations = [
    migrations.CreateModel(
      ...
      fields=[
        ...
        ('rule', models.CharField(choices=[('acm', 'ACM Rule'), ('oi', 'OI Rule')], default='acm', max_length=12,
                                  verbose_name='Rule')),
        ('allowed_lang',
         models.CharField(default='c, cpp, java, python', max_length=192, verbose_name='Allowed languages')),
        ...
        ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='created_contests',
    ...
    migrations.CreateModel(
      ...
      fields=[
        ...
        ('status', models.CharField(
          choices=[('open', 'Question'), ('solve', 'Solved'), ('close', 'No Response'), ('note', 'Clarification')],
          max_length=12)),
    ...
    migrations.AddField(
      model_name='contest',
      name='participants',
      field=models.ManyToManyField(related_name='contests', through='contest.ContestParticipant',
                                   to=settings.AUTH_USER_MODEL),
    ),
    migrations.AddField(
      model_name='contest',
