...
from accounts.payment import change_username
from accounts.permissions import is_admin_or_root
from commons.utils import auth_view
...
# from utils.fields import get_site_settings
...
def my_password_change(request):
    return auth_view.password_change(request, template_name='accounts/security.jinja2',
...
def my_password_reset(request):
    return auth_view.password_reset(request,
                                    template_name='accounts/password_reset.jinja2',
                                    post_reset_redirect='accounts:password_reset_done',
                                    email_template_name='accounts/password_reset_email.jinja2')


def my_password_reset_done(request):
    return auth_view.password_reset_done(request, template_name='accounts/password_reset_done.jinja2')
