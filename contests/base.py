...
from shares.models import Blog
from contests.models import Contest, ContestParticipant
from commons.utils.middleware import CloseSiteException
from commons.utils import is_contest_manager, is_contest_volunteer
from commons.utils.site_settings import is_site_closed
...
class BaseContestMixin(ContextMixin, UserPassesTestMixin):
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        self.participate_contest_status = self.contest.status       # the contests status for the participant
