...
class Contest(models.Model):
    ...
    analysis_blog_id = models.IntegerField("题解博客 ID", default=0)   # related to a shares id
...
class ContestProblem(models.Model):
    ...
    class Meta:
        unique_together = ('problems', 'contests')
        ordering = ['identifier']
...
class ContestParticipant(models.Model):
    ...
    join_time = models.DateTimeField(blank=True, null=True) # default: join when contests begins
    is_confirmed = models.BooleanField(default=False)

    def start_time(self, contest: Contest):
        # the contests should be a cached contests
