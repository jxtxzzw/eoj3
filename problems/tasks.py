...
from accounts.payment import reward_problem_ac, reward_contest_ac
from problems.dispatcher.judge import send_judge_through_watch
from problems.dispatcher.manage import upload_case, upload_checker, upload_interactor, upload_validator
from problems.dispatcher.models import Server
from problems.statistics import invalidate_user
from submission.models import Submission, SubmissionReport
from submission.util import SubmissionStatus
from commons.utils.detail_formatter import response_fail_with_timestamp
...
def upload_problem_to_judge_server(problem, server):
    """
    :param problem: the problems to be uploaded
