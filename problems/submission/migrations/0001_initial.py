    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contests', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='contests.Contest')),
                ('problems', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='problems.Problem')),
            ],
            options={
                'ordering': ['-pk'],
            },
