...
from commons.utils.language import LANG_CHOICE, transform_code_to_html
from commons.utils import datetime_display
...
class Submission(models.Model):
    ...
    # if contests is null, then it is visible outside
