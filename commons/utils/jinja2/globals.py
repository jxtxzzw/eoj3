...
from commons.utils import EndlessPaginator
...
def is_active(context, match, **kwargs):
    ...
    Example:
        active("contests:*")  turn on for all pages in contests namespace
        active("problems:title")  turn on for all pages in problems and with the name "starts with" title
