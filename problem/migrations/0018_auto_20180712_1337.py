  ...
  operations = [
    migrations.CreateModel(
      ...
      fields=[
        ...
        ('problem',
         models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='problem_contest_status',
                           to='problem.Problem')),
      ],
    ),
    migrations.CreateModel(
      ...
      fields=[
        ...
        ('ac_user_count', models.PositiveIntegerField()),
        ('total_user_count', models.PositiveIntegerField()),
        ('problem', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='problem_status',
                                         to='problem.Problem')),
      ],
    ),
    migrations.CreateModel(
      ...
      fields=[
        ...
        ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='submission_status',
