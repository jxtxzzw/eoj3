  ...
  operations = [
    migrations.AlterField(
      ...
      field=models.CharField(
        choices=[('change_username', 'Change Username'), ('download_case', 'Download Case'), ('reward', 'Reward'),
                 ('transfer', 'Transfer')], max_length=20),
    ),
    migrations.AlterField(
      model_name='user',
      name='avatar',
    ...
    migrations.AlterField(
      model_name='user',
      name='email',
      field=models.EmailField(error_messages={'unique': 'This email has already been used.'}, max_length=192,
