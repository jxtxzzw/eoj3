      ...
      fields=[
        ...
        ('lang',
         models.CharField(choices=[('c', 'C'), ('cpp', 'C++'), ('python', 'Python'), ('java', 'Java')], default='cpp',
                          max_length=12, verbose_name='Language')),
        ...
        ('status', models.IntegerField(
          choices=[(-3, 'Waiting'), (-2, 'Judging'), (-1, 'Wrong Answer'), (0, 'Accepted'), (1, 'Time Limit Exceeded'),
                   (2, 'Time Limit Exceeded'), (3, 'Memory Limit Exceeded'), (4, 'Runtime Error'), (5, 'System Error'),
                   (6, 'Compile Error'), (7, 'Idleness Limit Exceeded'), (8, 'Time Limit Exceeded')], default=-3)),
