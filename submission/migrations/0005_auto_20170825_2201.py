  ...
  operations = [
    ...
    migrations.AddField(
      ...
      field=models.IntegerField(
        choices=[(-4, 'Submitted'), (-3, 'Waiting'), (-2, 'Judging'), (-1, 'Wrong Answer'), (0, 'Accepted'),
                 ...
                 (4, 'Runtime Error'), (5, 'System Error'), (6, 'Compile Error'), (7, 'Idleness Limit Exceeded'),
                 (8, 'Time Limit Exceeded'), (11, 'Judge Error'), (12, 'Pretest Passed')], default=-4),
    ),
    migrations.AlterField(
      ...
      field=models.CharField(
        ...
        default='cpp', max_length=12, verbose_name='Language'),
    ),
    migrations.AlterField(
      model_name='submission',
      name='status',
